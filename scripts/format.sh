...
# goimports-reviser -company-prefixes "github.com/mehdihadeli" -project-name "github.com/mehdihadeli/go-vertical-slice-template" -rm-unused -set-alias -imports-order "std,general,company,project,blanked,dotted" -recursive ./...


gci write --skip-generated -s standard -s "prefix(github.com/mehdihadeli/go-vertical-slice-template)" -s default -s blank -s dot --custom-order  .
